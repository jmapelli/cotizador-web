...
@WebServlet(name = "CotizacionCrearServlet", urlPatterns = "/cotizacion/crear")
public class CotizacionCrearServlet extends HttpServlet {
    ...
    private void doPostDefault(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            CotizacionEntity cotizacion = cotizacionService.guardar(serie, numero, fecha, solicitante, sucursal,
                    cliente, subtotal, igv, total, items);
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/template/cotizacion/crear_result.jsp");
    ...
    private void doGetDefault(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        List<CotizacionDetalleEntity> items = new ArrayList<>();
        request.getSession().setAttribute("items", items);

        RequestDispatcher rd = request.getRequestDispatcher("/template/cotizacion/crear.jsp");
        rd.forward(request, response);
    }
