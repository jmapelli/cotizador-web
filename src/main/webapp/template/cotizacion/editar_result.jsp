    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" style="width: 100%; text-align: center;">Error al editar</h4>
                <% } else { %>
                <h4 class="modal-title" style="width: 100%; text-align: center;">Cotización editada</h4>
                <% } %>
            </div>
            <div class="modal-body" style="text-align: center">
                ...
                <% } else { %>
                La cotizacion <b><%=cotizacion.getSerie()%>-<%=cotizacion.getNumero()%></b> ha sido editada.
                <% } %>
            </div>
